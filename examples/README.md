...
Follow the quick start in our [README](../databricks_sql_connector/README.md) to install `databricks-sql-connector` and see
...
2. Follow the quick start in the [README](../databricks_sql_connector/README.md) to install the connector and obtain authentication credentials.
3. `cd examples/`
4. Then run any script using the `python` CLI. For example `python query_execute.py`

### Fetch with `curl`

1. Follow the quick start in the [README](../databricks_sql_connector/README.md) to install the connector and obtain authentication credentials.
