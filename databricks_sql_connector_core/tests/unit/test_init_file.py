...
class TestInitFile:
    """
    Micro test to confirm the contents of `databricks/__init__.py.py` does not change.
    ...
    def test_init_file_contents(self):
        with open("databricks_sql_connector_core/src/databricks/__init__.py.py") as f:
            init_file_contents = f.read()

        # This hash is the expected hash of the contents of `src/databricks/__init__.py.py`.
