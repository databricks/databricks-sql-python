...
class TestTokenFederationProvider(unittest.TestCase):
    ...
    def test_init_oidc_discovery(self, mock_get_endpoints, mock_requests_get):
        ...
        self.assertEqual(
            federation_provider.token_endpoint, "https://example.com/token"
        )
        ...
        federation_provider._init_oidc_discovery()
        self.assertEqual(
            federation_provider.token_endpoint, "https://example.com/oidc/v1/token"
        )
    ...
    def test_token_refresh(
        self, mock_is_same_host, mock_exchange_token, mock_parse_jwt
    ):
