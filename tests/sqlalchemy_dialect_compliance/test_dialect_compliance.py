...
@pytest.mark.skip(reason="Seeing consistent TABLE_DOES_NOT_EXIST error for all tests in this class.")
...
@pytest.mark.skip(reason="Date type implementation needs work. Cannot render literal values.")
...
@pytest.mark.skip(reason="xxxx implementation needs work")
...
@pytest.mark.skip(reason="CreateIndex is not supported in Unity Catalog + parameters cannot exceed 255 characters in length")
...
@pytest.mark.skip(reason="Date type implementation needs work. Timezone information not preserved.")
...
@pytest.mark.skip(reason="String implementation needs work. Quote escaping is inconsistent between read/write.")
...
@pytest.mark.skip(reason="DDL handling needs work. Some features not implemented in dialect.")
...
@pytest.mark.skip(reason="String implementation needs work. See comments from StringTest.")
...
@pytest.mark.skip(reason="Time type implementation needs work. Microseconds are not handled at all.")
...
@pytest.mark.skip(reason="Time type implementation needs work. Dialect cannot write literal values.")
...
@pytest.mark.skip(reason="Time type implementation needs work. Timezone not preserved. Cannot render literal values.")
